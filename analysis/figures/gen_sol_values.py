#!/usr/bin/env python3
"""Generate manuscript/values_sol.tex: LaTeX value macros for the cross-judge
...
out = ROOT / "manuscript/values_sol.tex"
out.parent.mkdir(parents=True, exist_ok=True)   # the manuscript dir is not in the repo
out.write_text("\n".join(lines) + "\n")
